...
func NewWriteTreeService(objectRepository repositories2.IObjectRepository, indexRepository repositories2.IIndexRepository) *WriteTreeService {
...
func (writeTreeService *WriteTreeService) buildTreeAndWrite(directory *DirectoryNode) (string, error) {
	...
	compressedContent, compressErr := encoding2.Compress(content)
	if compressErr != nil {
		return "", compressErr
	}
